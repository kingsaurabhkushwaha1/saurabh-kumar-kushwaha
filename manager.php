      ...
      <?php include "includes/sidebar.php" ?>
         ...
         <main class="page-content">
            ...
            <div class="ople_prdct_dev tabcontent" id="empl">
                  <h2 class="pb-4">  Manager Details</h2>
                  ...
                  <table class="table pt-3">
                     ...
                     $hod=$_GET['id'];
                           ...
                           $q="SELECT * FROM appraisal.user_master u inner join appraisal.user_role_mapping ur on u.userId=ur.userId inner join appraisal.department d on u.department_id=d.department_id where HOD=$hod and ur.roleId=3";
                        ...
                        ?>
                     <tbody>
                     <!-- <tr><td scope="col"><?php  echo $row['userId']?></td> -->
                     <td scope="col" align="center"><?php  echo $row['department_name']?></td>
                          ...
                          ( <?php  echo $row['userId']?>)</td>
                           ...
                           <td scope="col">
                             <a href="employee.php?id='<?php  echo $row['userId']?>'"> <button type="button" class="btn btn-outline-secondary"> show employee list </button> </a> </td>
