...
<div class="pl-4 pr-4">
  ...
  <?php  
    ...
    $q="SELECT * from appraisal.department a inner join appraisal.user_master r on a.department_id=r.department_id  inner join appraisal.approve_view_goal p on r.userId=p.user_id where p.user_id=$goal_id ";
  ...
  <tr id = "tr<?php echo $row['id'] ?>">
    ...
    <div class='modal fade' id="Modalupdate<?php echo $row['id'] ?>" tabindex='-1' role='dialog' aria-labelledby='Modalupdate' aria-hidden='true'>
        <div id="<?php printf($username);?>" class='modal-dialog' role='document'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    <form action="update_viewgoal.php?kpi_id=<?php echo $goal_id ?> && id=<?php echo $row['id'] ?> " method='POST'>
                        <div class='row'>
                        <div class='form-group col-sm-6'>
                        ...
                        <!-- <div class='row'>
                            ...
                            <div id="<?php printf($username);?>" class='form-group col-sm-6'>
                                <label for='examplekpiid'>Resources Required</label>
                                <input type='text' name='required' class='form-control' id='examplekpidesc' aria-describedby='kpidesc' value="<?php echo $row['required'] ?>">
                            </div>
                        </div> -->
                        ...
                        if($role==2){
                         ...
                         <div id="<?php printf($username);?>" class='row re'>
                            <!-- <div id="<?php printf($username);?>" class='form-group col-sm-6 rating'>
                                <label for='rating'>Manager Rating</label>
                                <select class='form-control' name='manager_rating' id='rating' required>
                                    <option value='pending'>Pending</option>
                             ...
                             <!-- <div id="<?php printf($username); ?>" class='form-group col-sm-6'>
                                ...
                                <select class='form-control' name='h_approval' id='approval'>
                                    <option value='Pending'>Pending</option>
                                    <option value='Approval'>Approval</option>
                                    <option value='Reject'>Reject</option>
                                </select>
