<?php
   ...
   if ($result->num_rows > 0) {        
   	while ($roww = $resultt->fetch_assoc()) {
   		 echo $dname = $roww['department_name'];
      ...
      <div class="page-wrapper chiller-theme toggled">
         ...
         <main class="page-content">
            ...
            <div class="sidebar-search col-sm-6">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-sm-6 multi_select">
                           ...
                           <select type="checkbox" id="multi"  name="assign_kpi[]"  multiple>
                              <?php
                                echo $q="SELECT * FROM appraisal.kpi where category='$dname'";
               ...
               <input type="select" name="department_id"  class="form-control" id="id" value="<?php  echo $row['department_id'];?>">
               </div>
               </div>
               <div class="row">   
               ...
               <input type="text" name="department_name" class="form-control" id="exampleFormControlInput1" value="">
               </div>
               </div>
               </div>
